...
class AlarmForm(FlaskForm):
    play_file = SelectField('Choice', choices=[('1.1_Welcome','Уважаемые коллеги'),('2.1_Tech','В настоящее время наблюдаются технические проблемы в работе сервиса'),
                                               ('2.2_Plan','В настоящее время проводятся плановые технические работы, затрагивающие сервис'),
                                               ...
                                               ('4.1_Tech','Технические специалисты компании уже занимаются устранением сбоя'),
                                               ('4.2_Plan','По завершению работ сервис будет восстановлен.'),
                                               ('5.1_Bye','Спасибо за понимание.')], default=('1.1_Welcome','Уважаемые коллеги'))
